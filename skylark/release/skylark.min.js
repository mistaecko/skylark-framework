...
!function(skylark) {
    var _Bitmap = skylark.Bitmap, Texture = function() {
        ...
        return Texture.prototype.dispose = function() {}, Texture.createBitmap = function(width, height, color) {
            ...
            return image.src = _Bitmap.create(rows, 1), image;
            ...
            var image = new NativeImage();
            return image.src = canvas.toDataURL(), new skylark.ConcreteTexture(image, scale);
            ...
            var image = new NativeImage();
            return image.src = base64String, new skylark.ConcreteTexture(image);
            ...
            var origWidth = data.width, origHeight = data.height, legalWidth = skylark.MathUtil.getNextPowerOfTwo(origWidth), legalHeight = skylark.MathUtil.getNextPowerOfTwo(origHeight), canvas = skylark.Skylark.getHelperCanvas(legalWidth, legalHeight);
...
!function(skylark) {
    var TextField = function(_super) {
        ...
        return __extends(TextField, _super), TextField.prototype.dispose = function() {
            ...
            var image = new NativeImage();
            return image.src = canvas.toDataURL(), image;
    ...
    var MiniBitmapFont = function(_super) {
        ...
        return __extends(MiniBitmapFont, _super), Object.defineProperty(MiniBitmapFont, "texture", {
            get: function() {
                ...
                return img.src = MiniBitmapFont.IMAGE_DATA, new skylark.ConcreteTexture(img);
            },
            enumerable: !0,
            configurable: !0
