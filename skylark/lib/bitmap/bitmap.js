...
(function(window) {
    ...
    var freeExports = typeof exports !== 'undefined' && exports;

    /** Detect free variable `module` */
    var freeModule = typeof module !== 'undefined' && freeExports && module;

    /** Detect free variable `global`, from Node.js or Browserified code, and use it as `window` */
    var freeGlobal = typeof global !== 'undefined' && global;
    ...
    var generateBitmapDataURL = function(rows, scale) {
    ...
    // check for `exports` after `define` in case a build optimizer adds an `exports` object
        ...
        if (freeModule) {
            (freeModule.exports = api).Bitmap = api;
        }
        // in Narwhal or RingoJS v0.7.0-
        else {
            freeExports.Bitmap = api;
        }
    }
    else {
